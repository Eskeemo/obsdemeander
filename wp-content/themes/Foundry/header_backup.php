	...
	<body <?php body_class(); ?>>
		...
		<div class="off-canvas-wrap" data-offcanvas aria-hidden="true">
			<div class="inner-wrap">
				    ...
				    <nav class="top-bar transparent darkshadow" data-topbar role="navigation">
						<section class="title-area">
							<div class="logo-large">
								<a href="<?php bloginfo ('home');?>"><img class="lightshadow" src="<?php echo get_template_directory_uri(); ?>/library/img/logo-full.jpg" /></a>
							</div>
						</section>
				...
				<!-- second instance of top-bar for sliding animation -->
				<div class="nav-floater contain-to-grid show-for-medium-up">
				    <nav class="top-bar" data-topbar role="navigation">
						<section class="title-area">
							<div class="logo-small">
								<a href="<?php bloginfo ('home');?>"><img src="<?php echo get_template_directory_uri(); ?>/library/img/logo-small.png" /></a>
							</div>
						</section>
				        <section class="top-bar-section">
				            <?php eskeemo_top_bar_l(); ?>
				...
				<section class="container header-waypoint" data-animate-down="header-show" data-animate-up="header-hide" role="document">
